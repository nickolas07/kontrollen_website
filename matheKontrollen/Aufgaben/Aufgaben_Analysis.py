...
def logarithmusgesetze(nr, anzahl=2):
...
def rechenregeln_integrale(nr, anzahl=2):
...
def ableitungen(nr, teilaufg=['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j'], anzahl=3):
    # Ableitungen
...
def kurvendiskussion_polynom_parameter_2(nr, teilaufg=['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j']):
    ...
    if 'd' in teilaufg:
        ...
        aufgabe.append(str(liste_teilaufg[i]) + ') Berechnen Sie die ersten drei Ableitungen der Funktion. \n\n')
