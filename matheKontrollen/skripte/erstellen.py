...
def test_erzeugen(liste_seiten, angaben, anzahl=0, probe=False):
    def erzeugen_test(Teil, liste_seiten, angaben):
        ...
        Datum = datetime.date.today().strftime('%d.%m.%Y') if in_tagen is not None else in_tagen
        ...
        def Hausaufgabenkontrolle():
            ...
            if schnell:
                ...
                table1 = Tabular('|p{1.2cm}|p{2.5cm}|p{2.5cm}|p{2.5cm}|p{2cm}|p{2.5cm}|', row_height=1.2)
    ...
    if probe:
        erzeugen_test('Probe', liste_seiten, angaben)
    else:
        erzeugen_test('Test', liste_seiten, angaben)
...
def klausur(liste_seiten_teil1, angb_teil1, liste_seiten_teil2, angb_teil2):
    def erzeugen_kl_teil_1(liste_seiten_teil1, angb_teil1):
        ...
        identifier, uuid = angb_teil1[-2], angb_teil1[-1]
        ...
        def Teil_1():
            ...
            table1.add_row((MultiColumn(2, align='l',
                                        data=MediumText(
                                            bold(f'Klausur im {Semester}. Semester der {Phase} am {Datum}'))),))
    ...
    def erzeugen_kl_teil_2(liste_seiten_teil2, angb_teil2):
        ...
        identifier, uuid = angb_teil2[-2], angb_teil2[-1]
        Datum = (datetime.date.today() + datetime.timedelta(days=in_tagen)).strftime('%d. %B %Y')
        print(f'\033[38;2;100;141;229m\033[1m\033[0m')
    ...
    if liste_seiten_teil1 is None and angb_teil1 is None:
        erzeugen_kl_teil_2(liste_seiten_teil2, angb_teil2)
    if liste_seiten_teil2 is None and angb_teil2 is None:
